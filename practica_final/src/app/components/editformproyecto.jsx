...
export default function EditProjectForm({ onSubmit, initialData, initialClientId }) {
              ...
              fetch('https://bildy-rpmaya.koyeb.app/api/client', {
                  ...
                  .then((data) => {
                      ...
                      if (initialData?.clientId) {
                        const client = data.find(client => client._id === initialData.clientId);
                        if (client) {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex items-start justify-center p-0">
            <form onSubmit={handleSubmit} className="bg-white p-10 rounded-lg shadow-lg w-full max-w-6xl">
                <h2 className="text-3xl font-bold mb-8 text-gray-800 text-center">Editar Proyecto</h2>
                <div className="mb-6">
                ...
                <button type="submit" className="w-full bg-blue-600 text-white p-3 rounded-md hover:bg-blue-700 transition duration-300">Guardar cambios</button>
            </form>
            <div className="mb-6 ">
              <div className="mb-6 ">
                <div className="block text-gray-700 font-semibold mb-2 ml-8 ">Cliente asociado a el proyecto</div>
                <select
                    name="clientes"
                    value={selectedClient ? selectedClient._id : ''}
                    onChange={handleSelectClient}
                    className="justify-center w-96 p-3 mb-2 ml-8 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-600"
                >
